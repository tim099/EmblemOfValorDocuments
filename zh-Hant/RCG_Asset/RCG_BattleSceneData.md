...
| 編輯器顯示 | 必填 | 說明 |
|---|---|---|
| **SceneType** | — | <!-- TODO: 說明欄位用途 --> |
| **Image** | — | <!-- TODO: 說明欄位用途 --> |
| **FieldEffectDrops** | — | <!-- TODO: 說明欄位用途 --> |
| **HasGround** | — | <!-- TODO: 說明欄位用途 --> |
...
|---|---|---|---|---|
| `m_SceneType` | SceneType | `SceneType` | `SceneType` | |
| `m_Image` | Image | `RCG_SpriteData` | `Image` | |
| `m_FieldEffectDrops` | FieldEffectDrops | `RCG_FieldEffectDropPoolGenData` | `FieldEffectDrops` | |
| `m_HasGround` | HasGround | `bool` | `HasGround` | |
