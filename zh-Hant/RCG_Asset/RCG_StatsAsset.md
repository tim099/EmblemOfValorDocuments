...
| 編輯器顯示 | 必填 | 說明 |
|---|---|---|
| **HasSteamStat** | — | <!-- TODO: 說明欄位用途 --> |
| **SteamUserStat** | — | <!-- TODO: 說明欄位用途 --> |
| **GameStatsType** | — | <!-- TODO: 說明欄位用途 --> |
...
|---|---|---|---|---|
| `m_HasSteamStat` | HasSteamStat | `bool` | `HasSteamStat` | |
| `m_SteamUserStat` | SteamUserStat | `UCL_SteamUserStatAssetEntry` | `SteamUserStat` | UCL.Core.PA.Conditional(nameof(m_HasSteamStat), false, true) |
| `m_GameStatsType` | GameStatsType | `GameStatsType` | `GameStatsType` | |
