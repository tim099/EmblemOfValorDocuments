...
*   **繼承自**：`RCG_Asset<RCG_RuntimeData>, UCLI_FieldOnGUI`
...
|---|---|---|---|---|
| `m_StructType` | StructType | `RCG_RuntimeStructGenData` | `StructType` | |
| `m_DefaultValue` | DefaultValue | `RCG_RuntimeObject` | `DefaultValue` | |
