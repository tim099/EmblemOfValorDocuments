...
*   **繼承自**：`RCG_Asset<RCG_CardDropPool>, UCL.Core.UCLI_ShortName`
...
|---|---|---|---|---|
| `m_DropPool` | DropPool | `RCG_CardDropPoolGenData` | `DropPool` | |
| `m_Filters` | Filters | `List<CardDropFilter>` | `Filters` | |
| `m_Name` | Name | `RCG_LocalizeData` | `Name` | |
| `m_DropPool` | DropPool | `RCG_CommonDropSetting<RCG_CardGenData>` | `DropPool` | UCL.Core.PA.Conditional(nameof(m_DropType), false, EDropType.DropPool) |
