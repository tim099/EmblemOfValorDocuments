---
title: RCG_FieldEffectDropPool 說明
description: <!-- TODO: 一句話功能摘要 -->
last_updated: 2026-05-02
target_audience: [Designer, Modder, AI_Agent]
---

# RCG_FieldEffectDropPool
...
*   **繼承自**：`RCG_Asset<RCG_FieldEffectDropPool>, UCL.Core.UCLI_ShortName`
...
|---|---|---|---|---|
| `m_DropPool` | DropPool | `RCG_FieldEffectDropPoolGenData` | `DropPool` | |
| `m_DropPool` | DropPool | `RCG_CommonDropSetting<RCG_FieldEffectGenData>` | `DropPool` | UCL.Core.PA.Conditional(nameof(m_DropType), false, DropType.DropPool) |
