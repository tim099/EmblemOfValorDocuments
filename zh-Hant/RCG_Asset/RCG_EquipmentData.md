...
| **Unlock** | — | <!-- TODO: 說明欄位用途 --> |
| **UpgradeBranch** | — | <!-- TODO: 說明欄位用途 --> |
| **EnhenceLevel** | — | <!-- TODO: 說明欄位用途 --> |
| **HideInCodex** | — | <!-- TODO: 說明欄位用途 --> |
| **CanDropRepeatedly** | — | <!-- TODO: 說明欄位用途 --> |
...
*   **繼承自**：`RCG_Asset<RCG_EquipmentData>, RCGI_Item, RCGI_Unloackable`
...
| `m_EquipmentType` | EquipmentType | `EquipmentType` | `EquipmentType` | |
...
| `m_UpgradeBranch` | UpgradeBranch | `List<RCG_EquipmentGenData>` | `UpgradeBranch` | |
| `m_EnhenceLevel` | EnhenceLevel | `int` | `EnhenceLevel` | |
| `m_HideInCodex` | HideInCodex | `bool` | `HideInCodex` | |
| `m_CanDropRepeatedly` | CanDropRepeatedly | `bool` | `CanDropRepeatedly` | |
