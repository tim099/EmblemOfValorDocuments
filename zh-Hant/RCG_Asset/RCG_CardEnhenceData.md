...
| 編輯器顯示 | 必填 | 說明 |
|---|---|---|
| **LocalizeName** | — | <!-- TODO: 說明欄位用途 --> |
| **Rarity** | — | <!-- TODO: 說明欄位用途 --> |
| **Conditions** | — | <!-- TODO: 說明欄位用途 --> |
| **Effects** | — | <!-- TODO: 說明欄位用途 --> |
| **CardTags** | — | <!-- TODO: 說明欄位用途 --> |
| **EnhenceSettings** | — | <!-- TODO: 說明欄位用途 --> |
| **BannedUsedType** | — | <!-- TODO: 說明欄位用途 --> |
| **CostAlter** | — | <!-- TODO: 說明欄位用途 --> |
| **SetCardType** | — | <!-- TODO: 說明欄位用途 --> |
| **CardType** | — | <!-- TODO: 說明欄位用途 --> |
...
| `m_Conditions` | Conditions | `RCG_CE_AND_Condition` | `Conditions` | |
| `m_Effects` | Effects | `List<RCG_CommonEffect>` | `Effects` | |
| `m_CardTags` | CardTags | `List<RCG_CardTagGenData>` | `CardTags` | |
| `m_EnhenceSettings` | EnhenceSettings | `List<RCG_CardEnhenceSetting>` | `EnhenceSettings` | |
| `m_BannedUsedType` | BannedUsedType | `List<RCG_UsedTypeTagGenData>` | `BannedUsedType` | |
| `m_CostAlter` | CostAlter | `int` | `CostAlter` | |
| `m_SetCardType` | SetCardType | `bool` | `SetCardType` | |
| `m_CardType` | CardType | `CardType` | `CardType` | UCL.Core.PA.Conditional("m_SetCardType", false, true) |
