...
繼承自 `RCG_Asset<RCG_FieldEffectData>`，實作介面：`RCGI_Infos`, `UI.RCGI_StatusInfo //`, `RCGI_Status`
...
*   **繼承自**：`RCG_Asset<RCG_FieldEffectData>, RCGI_Infos, UI.RCGI_StatusInfo //, RCGI_Status`
*   **實作介面**：`RCGI_Infos`, `UI.RCGI_StatusInfo //`, `RCGI_Status`
