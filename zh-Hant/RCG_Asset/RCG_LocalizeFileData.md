---
title: RCG_LocalizeFileData 說明
description: <!-- TODO: 一句話功能摘要 -->
last_updated: 2026-05-02
target_audience: [Designer, Modder, AI_Agent]
---

# RCG_LocalizeFileData
...
| 編輯器顯示 | 必填 | 說明 |
|---|---|---|
| **DefaultLang** | — | <!-- TODO: 說明欄位用途 --> |
| **LocalizeFile** | — | <!-- TODO: 說明欄位用途 --> |
...
|---|---|---|---|---|
| `m_DefaultLang` | DefaultLang | `UCL_LanguageCodeEntry` | `DefaultLang` | |
| `m_LocalizeFile` | LocalizeFile | `Dictionary<UCL_LanguageCodeEntry, UCL_TextAssetEntry>` | `LocalizeFile` | |
