...
*   **繼承自**：`RCG_Asset<RCG_ItemDropPool>, UCL.Core.UCLI_ShortName`
...
|---|---|---|---|---|
| `m_DropPool` | DropPool | `RCG_ItemDropPoolGenData` | `DropPool` | |
...
| `m_RarityTag` | RarityTag | `RCG_RarityTagGenData` | `RarityTag` | UCL.Core.PA.Conditional(nameof(m_FilterType), false, FilterType.RarityTag) |
...
| `m_DropPool` | DropPool | `RCG_CommonDropSetting<RCG_ItemGenData>` | `DropPool` | UCL.Core.PA.Conditional("m_DropType", false, EDropType.DropPool) |
