...
| **Icon** | — | <!-- TODO: 說明欄位用途 --> |
| **Scale** | — | <!-- TODO: 說明欄位用途 --> |
| **BearingX** | — | <!-- TODO: 說明欄位用途 --> |
| **BearingY** | — | <!-- TODO: 說明欄位用途 --> |
...
| `m_Scale` | Scale | `float` | `Scale` | |
| `m_BearingX` | BearingX | `float` | `BearingX` | |
| `m_BearingY` | BearingY | `float` | `BearingY` | |
