...
|---|---|---|
| **Enable** | — | <!-- TODO: 說明欄位用途 --> |
| **InfoType** | — | <!-- TODO: 說明欄位用途 --> |
| **Variable** | — | <!-- TODO: 說明欄位用途 --> |
| **Order** | — | <!-- TODO: 說明欄位用途 --> |
| **HideIfZero** | — | <!-- TODO: 說明欄位用途 --> |
...
|---|---|---|---|---|
| `m_Enable` | Enable | `bool` | `Enable` | |
| `m_InfoType` | InfoType | `InfoType` | `InfoType` | |
| `m_Variable` | Variable | `IntVariable` | `Variable` | UCL.Core.PA.Conditional(nameof(m_InfoType), false, InfoType.IntVariable) |
| `m_Order` | Order | `int` | `Order` | |
| `m_HideIfZero` | HideIfZero | `bool` | `HideIfZero` | |
