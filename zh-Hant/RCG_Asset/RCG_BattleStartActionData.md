---
title: RCG_BattleStartActionData 說明
description: <!-- TODO: 一句話功能摘要 -->
last_updated: 2026-05-02
target_audience: [Designer, Modder, AI_Agent]
---

# RCG_BattleStartActionData
...
|---|---|---|
| **User** | — | <!-- TODO: 說明欄位用途 --> |
| **BattleStartActions** | — | <!-- TODO: 說明欄位用途 --> |
...
|---|---|---|---|---|
| `m_User` | User | `RCG_SelectTargetData` | `User` | |
| `m_BattleStartActions` | BattleStartActions | `List<RCG_BattleSetting>` | `BattleStartActions` | |
