...
|---|---|---|
| **Name** | — | <!-- TODO: 說明欄位用途 --> |
| **NextState** | — | <!-- TODO: 說明欄位用途 --> |
| **EnterStateActions** | — | <!-- TODO: 說明欄位用途 --> |
| **StateData** | — | <!-- TODO: 說明欄位用途 --> |
| **BattleState** | — | <!-- TODO: 說明欄位用途 --> |
...
| `m_NextState` | NextState | `RCG_BattleStateGenData` | `NextState` | |
| `m_EnterStateActions` | EnterStateActions | `List<RCG_BattleSetting>` | `EnterStateActions` | |
| `m_StateData` | StateData | `RCG_RuntimeData` | `StateData` | |
| `m_BattleState` | BattleState | `RCG_RuntimeDataConst` | `BattleState` | |
