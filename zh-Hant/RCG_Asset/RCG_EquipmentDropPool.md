---
title: RCG_EquipmentDropPool 說明
description: <!-- TODO: 一句話功能摘要 -->
last_updated: 2026-05-02
target_audience: [Designer, Modder, AI_Agent]
---

# RCG_EquipmentDropPool
...
| **RarityTag** | — | <!-- TODO: 說明欄位用途 --> |
| **Tag** | — | <!-- TODO: 說明欄位用途 --> |
| **OperatorType** | — | <!-- TODO: 說明欄位用途 --> |
| **EquipmentType** | — | <!-- TODO: 說明欄位用途 --> |
| **Filters** | — | <!-- TODO: 說明欄位用途 --> |
...
*   **繼承自**：`RCG_Asset<RCG_EquipmentDropPool>, UCL.Core.UCLI_ShortName`
...
|---|---|---|---|---|
| `m_DropPool` | DropPool | `RCG_EquipmentDropPoolGenData` | `DropPool` | |
| `m_FilterType` | FilterType | `FilterType` | `FilterType` | |
| `m_SkillTag` | SkillTag | `RCG_SkillTagGenData` | `SkillTag` | UCL.Core.PA.Conditional("m_FilterType", false, FilterType.SkillTag) |
| `m_RarityTag` | RarityTag | `RCG_RarityTagGenData` | `RarityTag` | UCL.Core.PA.Conditional("m_FilterType", false, FilterType.RarityTag) |
| `m_Tag` | Tag | `RCG_ItemTagGenData` | `Tag` | UCL.Core.PA.Conditional("m_FilterType", false, FilterType.Tag) |
| `m_OperatorType` | OperatorType | `OperatorType` | `OperatorType` | UCL.Core.PA.Conditional("m_FilterType", false, FilterType.Operator) |
| `m_EquipmentType` | EquipmentType | `EquipmentType` | `EquipmentType` | UCL.Core.PA.Conditional("m_FilterType", false, FilterType.EquipmentType) |
...
| `m_DropPool` | DropPool | `RCG_CommonDropSetting<RCG_EquipmentGenData>` | `DropPool` | UCL.Core.PA.Conditional("m_DropType", false, EDropType.DropPool) |
